...
' * added the ability to use a buffer (in previous versions, altitude and longitudes from the user where sometimes altered)
'
'locals
'------
'properties
...
'volgende vier eigenschappen kunnen niet veralgemeend worden
...
Public Property Get CurrentLimit() As typZoom
...
Public Sub DrawLine(ByVal vLongitude1 As Double, ByVal vLatitude1 As Double, ByVal vLongitude2 As Double, ByVal vLatitude2 As Double)
  Dim hulpDrawLines As Boolean
  '
  hulpDrawLines = mDrawLines  'if drawing points only, disable it only for this call of DrawLine()
  '
  mDrawLines = True
  BreakLine
  DrawPoint vLongitude1, vLatitude1
  DrawPoint vLongitude2, vLatitude2
  '
  mDrawLines = hulpDrawLines
End Sub
...
Public Function Carc_Distance_Tussen(vLatitude1 As Double, vLongitude1 As Double, vLatitude2 As Double, vLongitude2 As Double) As Double
  Carc_Distance_Tussen = mdlCalculateDistance.Carc_Distance_Tussen(vLatitude1, vLongitude1, vLatitude2, vLongitude2)
End Function

Public Sub Navigate(vDirection As enmDirection, Optional vStep As Byte = 25)
  Dim hulpCurrentLimit As typZoom
  '
  hulpCurrentLimit = mdlNavigate.Navigate(IsDrawing, mCurrentLimit, ZoomHistory, vDirection, vStep)
  Call SystemZoomIn(hulpCurrentLimit.N, hulpCurrentLimit.O, hulpCurrentLimit.Z, hulpCurrentLimit.W, True)
End Sub
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
  mdlPropertyBag.ReadProperties Me, PropBag
  '
  ...
  Call VoegZoomHistoryToTableToe(mCurrentLimit.N, mCurrentLimit.O, mCurrentLimit.Z, mCurrentLimit.W)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
  mdlPropertyBag.WriteProperties Me, PropBag
End Sub

Private Sub UserControl_InitProperties()
  mdlPropertyBag.InitProperties Me, UserControl.BackColor
End Sub
